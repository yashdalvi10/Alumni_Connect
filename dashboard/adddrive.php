    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Add Drive</li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"> <i class="bi bi-bag-plus-fill"></i> Add New Drive</h5>
              ...
              <form action="addproductdb.php" method="POST">
                ...
                <div class="row mb-3">
                  <label for="text" class="col-sm-2 col-form-label">For which Branch</label>
                  <div class="col-sm-10">
                    <input type="text" name="Branch" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="date" class="col-sm-2 col-form-label">Drive Date</label>
                  <div class="col-sm-10">
